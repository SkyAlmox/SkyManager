...
const categories = ['Carregadores de Celular', 'Comunicação Visual', 'Estruturas para Mídia OOH', 'Marcenaria', 'Projetos Especiais de Arquitetura', 'Totens Digitais e Interativos'];
