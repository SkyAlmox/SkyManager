    ...
    },
    {
        ...
        content: (
            <div className="space-y-12">
                <p className="text-brand-dark/70 text-center max-w-2xl mx-auto text-xl leading-relaxed">
                ...
                <div className="flex flex-col items-center gap-12 pt-12">
                    <div className="text-center space-y-3 max-w-xl mx-auto">
                        <p className="text-2xl md:text-3xl font-serif text-brand-dark leading-tight">
                            Pelo <span className="text-[#039AAD] font-bold">WhatsApp</span> é mais <span className="italic font-bold text-[#039AAD]">RÁPIDO</span>!
                        </p>
                        <p className="text-xs uppercase tracking-[0.2em] text-brand-dark/40 font-medium">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 w-full">
                        ...
                        <div className="bg-brand-dark/5 p-8 rounded-sm border border-brand-hover/10 flex flex-col items-center text-center space-y-4">
                            <span className="text-[10px] uppercase tracking-[0.2em] text-[#039AAD] font-bold">Comercial</span>
                            <h4 className="text-xl font-serif text-brand-dark">RODRIGO DOMUSCI</h4>
                            <div className="space-y-2 pt-4 w-full">
                                <a
                                    href="https://wa.me/5531983315015"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center justify-center gap-2 text-sm hover:text-brand-hover transition-colors text-brand-dark"
                                >
                        ...
                        {/* Contact 2 */}
                        <div className="bg-brand-dark/5 p-8 rounded-sm border border-brand-hover/10 flex flex-col items-center text-center space-y-4">
                            <span className="text-[10px] uppercase tracking-[0.2em] text-[#039AAD] font-bold">Comercial - Arquitetura</span>
                            <h4 className="text-xl font-serif text-brand-dark">FERNANDO RIBALDO</h4>
                            <div className="space-y-2 pt-4 w-full">
                                <a
